                        ...
                        <div class="card">
                            <form method="POST" enctype="multipart/form-data" >
                                ...
                                <div class="form-group">
                                    <label>자격 요건</label>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="category3" name="qualification" value="option1" required>
                                        <label class="form-check-label" for="category3">논문양식파일사용</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="category4" name="qualification" value="option2">
                                        <label class="form-check-label" for="category4">목차,서론,본론,결론,참고문헌 포함</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" id="category5" name="qualification" value="option3">
                                        <label class="form-check-label" for="category5">본인이 직접 작성한 파일임을 확인함</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="pageNumber">쪽수</label>
                                    <input type="number" class="form-control" id="pageNumber" name="pageNumber" placeholder="0" required>쪽 (표지/목차 제외)
                                </div>
                                <div class="form-group">
                                    <label>파일 제출</label>
