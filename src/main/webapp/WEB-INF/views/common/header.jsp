        ...
        <nav class="navbar navbar-expand-lg navbar-default">
            ...
            <div class="collapse navbar-collapse" id="navbar-default">
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown ">
                        <a class="nav-link dropdown-toggle" href="/api/graduation/announcement" aria-haspopup="true"
                            aria-expanded="false" data-bs-display="static">
                            안내 및 내규
                        </a>
                    </li>
                    ...
                    <c:if test="${fn:contains(userId, 'admin')}">
                        <li class="nav-item dropdown ">
                            <a class="nav-link dropdown-toggle" href="/api/graduation/application_management"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                data-bs-display="static">
                                신청서 접수 관리
                            </a>
                    ...
                    <c:if test="${not fn:contains(userId, 'admin')}">
                        <li class="nav-item dropdown ">
                            <a class="nav-link dropdown-toggle" href="/api/graduation/graduation_status"
                                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                data-bs-display="static">
                                나의 졸업 현황
                            </a>
